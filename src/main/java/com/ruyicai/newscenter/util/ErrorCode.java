package com.ruyicai.newscenter.util;
...
public enum ErrorCode {
	...
	Userlogin_Error("20120820","用户名或者密码不正确！"),
	...
	public static void main(String[] args) {
		ErrorCode result = ErrorCode.PRESENT_Randomcode_Timeout;
		System.out.println(result.memo +result.value);
	}
}
